import{ab as a,E as e,F as c,C as n,Q as o,L as p,ac as t,U as l}from"./framework-c74165a4.js";const i={},d=t(`<h1 id="面试官-说说var、let、const之间的区别" tabindex="-1"><a class="header-anchor" href="#面试官-说说var、let、const之间的区别" aria-hidden="true">#</a> 面试官：说说var、let、const之间的区别</h1><figure><img src="https://static.vue-js.com/d2aba2e0-50f7-11eb-85f6-6fac77c0c9b3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="一、var" tabindex="-1"><a class="header-anchor" href="#一、var" aria-hidden="true">#</a> 一、var</h2><p>在ES5中，顶层对象的属性和全局变量是等价的，用<code>var</code>声明的变量既是全局变量，也是顶层变量</p><p>注意：顶层对象，在浏览器环境指的是<code>window</code>对象，在 <code>Node</code> 指的是<code>global</code>对象</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">var</span> a <span class="token operator">=</span> <span class="token number">10</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用" tabindex="-1"><a class="header-anchor" href="#使用" aria-hidden="true">#</a> 使用</h3><p>能用<code>const</code>的情况尽量使用<code>const</code>，其他情况下大多数使用<code>let</code>，避免使用<code>var</code></p><h2 id="参考文献" tabindex="-1"><a class="header-anchor" href="#参考文献" aria-hidden="true">#</a> 参考文献</h2>`,70),r={href:"https://es6.ruanyifeng.com/",target:"_blank",rel:"noopener noreferrer"};function u(v,k){const s=l("ExternalLinkIcon");return e(),c("div",null,[d,n("ul",null,[n("li",null,[n("a",r,[o("https://es6.ruanyifeng.com/"),p(s)])])])])}const b=a(i,[["render",u],["__file","var_let_const.html.vue"]]);export{b as default};
